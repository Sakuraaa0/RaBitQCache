...
class EngineArgs:
    ...
    enable_rabitq: bool = CacheConfig.enable_rabitq
    rabitq_b_q: Optional[int] = CacheConfig.rabitq_b_q
    rabitq_topk: Optional[int] = CacheConfig.rabitq_topk
    rabitq_topp: Optional[float] = CacheConfig.rabitq_topp
    ...
    def create_engine_config(
        ...
        cache_config = CacheConfig(
            ...
            enable_rabitq=self.enable_rabitq,
            rabitq_b_q=self.rabitq_b_q,
            rabitq_topk=self.rabitq_topk,
            rabitq_topp=self.rabitq_topp,
        )
