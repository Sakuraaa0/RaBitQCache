...
class CudaPlatformBase(Platform):
    ...
    def get_attn_backend_cls(cls, selected_backend, head_size, dtype,
        ...
        if use_v1:
            ...
            RABITQ_V1 = "vllm.v1.attention.backends.rabitq.RabitQAttentionBackend"  # noqa: E501
            ...
            if selected_backend == _Backend.FLASHINFER:
                ...
                return XFORMERS_V1
            elif selected_backend == _Backend.RABITQ_VLLM_V1:
                logger.info_once("Using RabitQ backend on V1 engine.")
                return RABITQ_V1
