...
def _make_metadata_with_slice(
    ...
    req_ids = (attn_metadata.req_ids[request_slice]
               if attn_metadata.req_ids is not None else None)
...
def make_local_attention_virtual_batches(
    ...
    return CommonAttentionMetadata(
        ...
        causal=True,
        req_ids=(list(common_attn_metadata.req_ids)
                 if common_attn_metadata.req_ids is not None else None),
    )
...
def make_kv_sharing_fast_prefill_common_attn_metadata(
    ...
    original_req_ids = (list(common_attn_metadata.req_ids)
                        if common_attn_metadata.req_ids is not None else
                        None)
